 ...
 * 
 *         Main purpose - get SSM connection and process basic fields
 */
public abstract class MoexFeed extends FPFeed implements IFPField {
	...
	public Endpoint getEndpoint() throws FastConnectionException {
		...
		try {
			...
			String group = FXPXml.readConnectionElement(sitename,
					SSMConnection.GROUP_IP);
			String ifaddr = FXPXml.readConnectionElement(sitename,
					SSMConnection.INTERFACE_IP);
